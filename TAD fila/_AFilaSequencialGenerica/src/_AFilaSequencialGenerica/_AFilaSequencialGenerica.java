package _AFilaSequencialGenerica;

import java.util.Scanner;

/*
Teste a Fila dinâmica e sequencial com classe
Usa a fila para calcular o produto de dois números
criação: 28/02/2023.
prof. Dr. Ivan Carlos Alcântara de Oliveira
*/
public class _AFilaSequencialGenerica {
	...
	public static void main(String[] args) {
		try {
		   ...
		   FilaSequencial<Integer>  F = new FilaSequencial<Integer>();
